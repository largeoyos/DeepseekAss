...
- 正文避免 AI 腔、宣传腔、总结腔和金句式段尾；不把普通事件拔高成象征、证明、时代意义或人生答案。
- 尽量不用“不是……而是……”“不仅……而且/更……”等模板对比和递进；需要对比时直接写动作、事实、差异或感受。偶尔一次自然使用不必生硬回避，但不得成片出现。
- 不把人物称为某段关系、变化或时代的“参与者、见证者、守护者、旁观者”；写清他实际做了什么、看见了什么、承担了什么。
- 少用“此外、关键、至关重要、复杂性、彰显、体现、标志着、充满活力、深刻、命运、宿命”等抽象套话，少写“仿佛在诉说”“空气中弥漫着”“心头一震”等万能反应。
- 细节服从当前视角和叙事作用。选择人物当下会注意的动作、物件、声音或环境，不罗列感官，不给每句话配眼神、停顿、微表情和心理说明。
- 优先使用准确的名词和动词。允许朴素句、轻微不规则的节奏、短段落和留白；不要把每段套成“环境—动作—心理—升华”。
- 情绪和关系通过选择、对话、动作及后果显现；读者已经能读懂的内容不再由旁白解释，不在段尾强行总结主题。
- 去 AI 腔只调整表达方式，不得改变剧情事实、人物行为、叙事视角、对白意图或事件顺序。
""".strip()
...
# humanizer-zh
1. 去掉抽象拔高、宣传腔、总结腔和金句式段尾，不把普通事件解释成象征或人生答案。
2. “不是……而是……”“不仅……而且/更……”等模板句偶尔自然出现可以保留，成片出现时改为直接陈述事实、动作或差异。
3. 不用“参与者、见证者、守护者、旁观者”等抽象身份替代人物的实际行动、观察和代价。
4. 细节服从当前视角与叙事作用，不罗列感官，不给每句话配眼神、停顿、微表情、身体反应和心理解释。
5. 优先使用准确的名词和动词，允许朴素句、轻微不规则节奏、短段落与留白，不套“环境—动作—心理—升华”结构。
6. 情绪通过选择、对话、动作和后果显现；信任读者，不重复解释已经写明的内容。
7. 保留原意、事实、人物行为、视角、事件顺序和对白意图；去 AI 腔不能改剧情。
